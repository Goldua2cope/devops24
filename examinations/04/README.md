...
#### Answer:
> All tasks will be run in privileged mode(root user).
...
#### Answer:
> We need to first stop the service to be able to uninstall it
...
#### Answer:
> "Ensure nginx is disabled and not running" 